...
#
# The tfcv Software is licensed under the terms of the UCLB ACP-A licence
    ...
    def __init__(self, data_path, filenames_file, params, dataset, mode):
        ...
        if mode == 'train':
            ...
            self.left_image_batch, self.right_image_batch = tf.train.batch([left_image, right_image],
                        params.batch_size, capacity=capacity, num_threads=params.num_threads)
